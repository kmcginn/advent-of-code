...
MY NOTES:
the "sides" of the square made by the spiral increase by 2 each time - so all ODD numbers
then the bottom right of a full square is the AREA of that square, or the max of that "ring"
